...
module.exports = {
  ...
  fields: {
    ...
    member: { label: "identifiers", type: Relationship, many: false, ref: 'People' },
    person: { label: "類型", type: Relationship, many: false, ref: 'People' },
    ...
    contact_details: { label: "contact_details", type: Text},
    links: { label: "相關連結", type: Text},
    posts: { label: "posts", type: Relationship, many: false, ref: 'Posts' },
