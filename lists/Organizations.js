...
module.exports = {
  fields: {
    ...
    founding_date_year: { label: "創立年", type: Integer },
    founding_date_month: { label: "創立月", type: Integer },
    founding_date_day: { label: "創立日", type: Integer },

    dissolution_date_year: { label: "解散年", type: Integer },
    dissolution_date_month: { label: "解散月", type: Integer },
    dissolution_date_day: { label: "解散日", type: Integer },
